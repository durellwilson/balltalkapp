...
// Define the CI runner file content
...
// Write the CI runner file
const ciRunnerFilePath = path.join(workflowsDir, 'run-audio-ci.js');
fs.writeFileSync(ciRunnerFilePath, ciRunnerContent);

console.log(`CI runner file created at: ${ciRunnerFilePath}`); 